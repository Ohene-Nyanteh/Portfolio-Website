...
export default function ExpertiseSection() {
  ...
  return (
    <div className="w-full h-full relative">
      ...
      <div className="absolute top-0 left-0 p-10 w-full h-full flex flex-col  md:gap-6 justify-evenly md:p-10">
        <animated.div ref={ref} style={springs}>
          <div
            className="w-full text-center md:text-6xl font-[cursive] italic text-3xl"
            ref={ref}
          >
            Where
          </div>
        ...
        <animated.div ref={ref} style={springs2}>
          <div className=" md:text-[8rem] text-center bg-transparent text-4xl md:w-fit w-full md:ml-20 font-extrabold bg-gradient-to-r animate-bounce border-2 border-blue-500 md:leading-none from-blue-500 to-green-500 text-transparent bg-clip-text">
            EXPERTATIONS
          </div>
        </animated.div>
        <animated.div ref={ref} style={springs3}>
          <div className="md:text-6xl text-3xl ml-0 text-center font-[cursive] italic">
            Turns into
          </div>
        </animated.div>
